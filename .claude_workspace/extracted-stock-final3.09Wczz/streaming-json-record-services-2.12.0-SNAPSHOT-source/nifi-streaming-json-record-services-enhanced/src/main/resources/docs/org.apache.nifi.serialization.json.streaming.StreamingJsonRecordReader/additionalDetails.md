...
Unsupported parsing, encoding, or schema cases use a correctness-preserving typed fallback. The service is opt-in and does not change `JsonTreeReader` behavior.
