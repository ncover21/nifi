...
public final class StreamingJsonRecordSetWriter extends StreamingDateTimeTextRecordSetWriter implements RecordSetWriterFactory {
    ...
    public RecordSetWriter createWriter(final ComponentLog logger, final RecordSchema schema, final OutputStream out, final Map<String, String> variables) throws SchemaNotFoundException, IOException {
        ...
        final OutputStream bufferedOut = COMPRESSION_FORMAT_NONE.equalsIgnoreCase(compressionFormat)
                ? out
        ...
        return new StreamingJsonWriteResult(logger, schema, getSchemaAccessWriter(schema, variables), compressionOut, prettyPrint, nullSuppression, outputGrouping,
